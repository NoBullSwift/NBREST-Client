...
class NBJSON {
    ...
    class Utils {
        class func printObject(object: Any, tabs: Int = 0) {
            if (object is Dictionary<String, Any>) {
                printMap(object: object as! Dictionary<String, Any>, tabs: tabs)
            } else if (object is Array<Any>) {
                printList(object: object as! Array<Any>, tabs: tabs)
            }
        }
        
        private class func printMap(object object: Dictionary<String, Any>, tabs: Int = 0) {
            for (key, value) in object {
                printTabs(tabs)
                print("\(key) => ", terminator:"")
                if (value is Array<Any>) {
                    print()
                    printList(object: value as! Array<Any>, tabs: tabs + 1)
                } else if (value is Dictionary<String, Any>) {
                    print()
                    printMap(object: value as! Dictionary<String, Any>, tabs: tabs + 1)
                } else {
                    print(value)
                }
            }
        ...
        private class func printList(object object: Array<Any>, tabs: Int = 0) {
        ...
        private class func printTabs(amount: Int) {
            for _ in 0 ..< amount {
                print("\t", terminator:"")
            }
        }
